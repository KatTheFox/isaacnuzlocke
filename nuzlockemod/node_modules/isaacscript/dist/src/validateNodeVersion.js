...
function validateNodeVersion() {
    ...
    console.error(`IsaacScript requires a Node.js version of ${chalk_1.default.red("16.0.0")} or greater.`);
    console.error("Please upgrade your version of Node.js before using IsaacScript.");
    process.exit(1);
}
