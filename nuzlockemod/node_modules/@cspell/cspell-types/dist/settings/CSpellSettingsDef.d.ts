 ...
 */
export declare type CSpellPackageSettings = CSpellUserSettings;
export declare type CSpellUserSettings = CSpellSettings;
 ...
 */
export declare type DictionaryRef = DictionaryId;
/**
 ...
 * @pattern ^(?=!+[^!*,;{}[\]~\n]+$)(?=(.*\w)).+$
 */
export declare type DictionaryNegRef = string;
/**
 ...
 */
export declare type DictionaryReference = DictionaryRef | DictionaryNegRef;
/** This is a written language locale like: 'en', 'en-GB', 'fr', 'es', 'de', etc. */
export declare type LocaleId = string;
/**
 * Configuration File Version
 */
export declare type VersionLatest = '0.2';
/**
 * Legacy Configuration File Versions
 * @deprecated
 * @deprecationMessage Use `0.2`
 */
export declare type VersionLegacy = '0.1';
export declare type Version = VersionLatest | VersionLegacy;
/**
 * @deprecated
 * @deprecationMessage Use LocaleId instead
 */
export declare type LocalId = LocaleId;
...
export declare type CSpellUserSettingsWithComments = CSpellUserSettings;
export declare type Source = FileSource | MergeSource | InMemorySource | BaseSource;
